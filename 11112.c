...
int main(void){
  ...
  a = first4(x);
  b = last4(x);
  c3 = (a*a*(long)100000000 + 2*(long)a*b*10000 + b*b) % 10000;
  c2 = (((a*a*(long)100000000 + 2*(long)a*b*10000 + b*b) - c3) / 10000) % 100000000;
  c1 = (a*a*(long)100000000 + 2*(long)a*b*10000 + b*b) / (long)1000000000000;
